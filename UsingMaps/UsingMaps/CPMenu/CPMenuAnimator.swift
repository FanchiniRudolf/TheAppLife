...
public struct CPMenuAnimator {
    ...
    public func animation(delay: TimeInterval,animation: @escaping () -> Void, completion: @escaping (Bool) -> Void) {
        UIView.animate(withDuration: commonDuration!, delay: delay, usingSpringWithDamping: commonSpringWithDamping, initialSpringVelocity: commonSpringVelocity, options: UIView.AnimationOptions.curveEaseInOut, animations: animation, completion: completion)
    }
}
